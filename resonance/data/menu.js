...
export const mainDemoOnepage = [
  { href: "#home", text: "Home", className: "active" },
  { href: "#portfolio", text: "Rooms" },
  { href: "#portfolio", text: "Resturant" },
  { href: "#portfolio", text: "Events" },
  { href: "#about", text: "About" },
  { href: "#contact", text: "Contact" },
];
    ...
    subMenu: [
      {
        title: "Our Rooms",
        links: [
          { href: "/main-multi-page#portfolio", text: "Single Bed Standard Room" },
          { href: "/main-multi-page#portfolio", text: "Double Bed Standard Room " },
          { href: "/main-multi-page#portfolio", text: "Standard Family Room" },
          {
